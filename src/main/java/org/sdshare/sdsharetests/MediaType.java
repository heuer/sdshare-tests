...
public final class MediaType {
    ...
    /**
     * The Atom feed media type.
     */
    public static final MediaType ATOM_XML = MediaType.valueOf(IConstants.MEDIA_TYPE_ATOM_XML);

    /**
     * The XTM media type (either XTM 1.0 or 2.0).
     */
    public static final MediaType XTM = MediaType.valueOf(IConstants.MEDIA_TYPE_XTM);

    /**
     * XTM 1.0 media type.
     */
    public static final MediaType XTM_10 = MediaType.valueOf(IConstants.MEDIA_TYPE_XTM_10);

    /**
     * XTM 2.0 media type.
     */
    public static final MediaType XTM_20 = MediaType.valueOf(IConstants.MEDIA_TYPE_XTM_20);

    /**
     * XTM 2.1 media type.
     */
    public static final MediaType XTM_21 = MediaType.valueOf(IConstants.MEDIA_TYPE_XTM_21);

    /**
     * CTM 1.0 media type.
     */
    public static final MediaType CTM = MediaType.valueOf(IConstants.MEDIA_TYPE_CTM);

    /**
     * RDF/XML media type.
     */
    public static final MediaType RDF_XML = MediaType.valueOf(IConstants.MEDIA_TYPE_RDF_XML);
